...
import { formatCurrency, formatDecimalPercent, formatPhone, truncate, capitalize, enumLabel } from '../utils/formatters'
...
describe('formatDecimalPercent', () => {
  it('formats decimal commission as percentage', () => {
    expect(formatDecimalPercent(0.2)).toBe('20%')
  })
})
