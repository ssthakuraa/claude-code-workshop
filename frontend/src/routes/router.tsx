...
const LoadingSpinner = () => (
  <div className="flex items-center justify-center min-h-screen bg-neutral-50">
    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[color:var(--hr-shell-accent)]" />
  </div>
)
...
const MyAssessmentsPage = lazy(() => import('@/pages/employees/MyAssessmentsPage').then(m => ({ default: m.MyAssessmentsPage })))
const AssessmentEntryPage = lazy(() => import('@/pages/employees/AssessmentEntryPage').then(m => ({ default: m.AssessmentEntryPage })))
...
const AssessmentCycleSetupPage = lazy(() => import('@/pages/admin/AssessmentCycleSetupPage').then(m => ({ default: m.AssessmentCycleSetupPage })))
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'employees/assessments', element: <S><MyAssessmentsPage /></S> },
          { path: 'employees/assessments/new', element: <S><AssessmentEntryPage /></S> },
          { path: 'employees/assessments/:assessmentId', element: <S><AssessmentEntryPage /></S> },
          ...
          // HR Specialist / Admin only
          {
            ...
            children: [
              ...
              { path: 'admin/assessment-cycles', element: <S><AssessmentCycleSetupPage /></S> },
            ],
          },
        ],
      },
