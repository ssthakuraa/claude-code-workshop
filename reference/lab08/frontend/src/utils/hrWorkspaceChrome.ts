...
const WORKSPACE_DESTINATIONS: WorkspaceDestination[] = [
  ...
  { id: 'departments', label: 'departments', href: '/hr/organization/departments' },
  { id: 'jobs', label: 'jobs', href: '/hr/organization/jobs' },
...
export function getWorkspaceDestinationById(id: string) {
  ...
  const localizedLabels: Record<string, string> = {
    ...
    departments: i18n.t('departments', { ns: 'common' }),
    jobs: i18n.t('jobs', { ns: 'common' }),
