...
public class HrFormatter {
    ...
    private static final HrLogHelper LOGGER = new HrLogHelper(HrFormatter.class);
    ...
    public String formatSalary(BigDecimal amount, String currencyCode, Locale locale) {
        ...
        try {
            ...
            LOGGER.warn("Falling back to plain salary formatting for currencyCode={}", currencyCode);
