...
import com.company.hr.resource.HrAssessmentCycleResource;
import com.company.hr.resource.HrAuditLogResource;
import com.company.hr.resource.HrCountryResource;
import com.company.hr.resource.HrDashboardResource;
import com.company.hr.resource.HrDepartmentResource;
import com.company.hr.resource.HrEmployeeAssessmentResource;
...
import com.company.hr.resource.HrLocationResource;
...
/**
 * Explicit Jersey registration for the rewrite foundation.
 */
    ...
    public HrApplicationConfig(HrRuntimeConfig runtimeConfig) {
        ...
        register(new AbstractBinder() {
            ...
            protected void configure() {
                ...
                bind(new HrAssessmentCycleJdbcRepository()).to(HrAssessmentCycleJdbcRepository.class);
                ...
                bind(new HrEmployeeAssessmentJdbcRepository()).to(HrEmployeeAssessmentJdbcRepository.class);
        ...
        register(HrLocationResource.class);
        register(HrCountryResource.class);
        register(HrAuditLogResource.class);
        register(HrAssessmentCycleResource.class);
        register(HrEmployeeAssessmentResource.class);
