-- V1: Baseline Schema
-- Converted from database/schema.sql (Vertex Tech HR schema → MySQL)
-- DO NOT EDIT this file. Future changes go in V2, V3, etc.
...
CREATE TABLE employees (
    ...
    manager_id INT,
    department_id INT,
    employment_status ENUM('ACTIVE','ON_LEAVE','TERMINATED','PROBATION') NOT NULL DEFAULT 'ACTIVE',
...
ALTER TABLE departments
    ADD COLUMN parent_department_id INT NULL,
...
CREATE TABLE hr_employee_documents (
    ...
    document_category VARCHAR(50) NOT NULL COMMENT 'Contract, ID, Certificate, Payslip, Other',
